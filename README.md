...
| [**adianti-form-field-style**](skills/adianti-form-field-style/SKILL.md) | Padroniza o estilo de código na criação e configuração de campos de formulário. | Ao declarar campos (TEntry, TCombo, etc.) em formulários e filtros. |
