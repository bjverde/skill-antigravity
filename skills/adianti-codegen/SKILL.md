...
description: >
  Cria telas List.php e Form.php para o Adianti Framework seguindo os padrões do projeto.
...
Esta skill fornece diretrizes e templates para a criação de telas de consulta (`List.php`) e cadastro (`Form.php`) utilizando o Adianti Framework.
